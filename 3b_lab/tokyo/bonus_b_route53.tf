...
locals {
  ...
  # Explanation: This is the app address that will growl at the galaxy (app.shinjuku-growl.com).
...
# # # Explanation: ACM asks “prove you own this planet”—DNS validation is shinjuku roaring in the right place.
resource "aws_route53_record" "shinjuku_acm_validation_records01" {
  ...
  zone_id = local.shinjuku_zone_id
...
# # Explanation: This ties the “proof record” back to ACM—shinjuku gets his green checkmark for TLS.
