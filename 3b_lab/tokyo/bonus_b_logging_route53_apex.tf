...
#Explanation: The zone apex is the throne room—shinjuku-growl.com itself should lead to the ALB.
resource "aws_route53_record" "shinjuku_apex_alias01" {
  zone_id = var.route53_hosted_zone_id #local.chewbacca_zone_id
...
# # # NOTE: This is a skeleton patch: students must merge this into aws_lb.shinjuku_alb01
# # # by adding/accessing the `access_logs` block. Terraform does not support "partial" blocks.
# # #
# # # Add this inside resource "aws_lb" "shinjuku_alb01" { ... } in bonus_b.tf:
# # #
# # # access_logs {
