...
resource "aws_route53_record" "shinjuku_apex_to_cf01" {
  zone_id = data.aws_route53_zone.shinjuku_existing_zone01.zone_id
...
# Explanation: app.shinjuku-growl.com also points to CloudFront — same doorway, different sign.
